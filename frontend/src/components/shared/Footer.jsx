      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://github.com/Solanki028" className="hover:text-gray-400" aria-label="Github">
            ...
            <a href="https://www.instagram.com/iam_inevitable2025/" className="hover:text-gray-400" aria-label="Instagram">
            ...
            <a href="https://www.linkedin.com/in/priyanshu-solanki/" className="hover:text-gray-400" aria-label="LinkedIn">
